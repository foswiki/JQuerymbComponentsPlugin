...
# $Rev: 7105 $ so that Foswiki can determine the checked-in status of the
# extension.
...
our $SHORTDESCRIPTION = 'add jquery.mb.components to JQueryPlugin';
...
sub initPlugin {
    ...
    # like this:
    # $Foswiki::cfg{Plugins}{JQuerymbComponentsPlugin}{ExampleSetting} = 1;
    ...
    # my $setting = $Foswiki::cfg{Plugins}{JQuerymbComponentsPlugin}{ExampleSetting} || 0;
...
JQuerymbComponentsPlugin is Copyright (C) 2009-2010 Foswiki Contributors.
